...
<style scoped>
  ...
  .index-board-car .index-board-item-inner {
    background: url(../assets/slideShow/images/1.png) no-repeat;
  }

  .index-board-loud .index-board-item-inner {
    background: url(../assets/slideShow/images/2.png) no-repeat;
  }

  .index-board-earth .index-board-item-inner {
    background: url(../assets/slideShow/images/3.png) no-repeat;
  }

  .index-board-hill .index-board-item-inner {
    background: url(../assets/slideShow/images/4.png) no-repeat;
  }
